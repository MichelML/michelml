  ...
  render() {
    return (
      <main className={this.props.classes.layout}>
        ...
        <p>
          Michel ML ("us", "we", or "our") operates the https://michelml.com/
          website (the "Service").
        </p>
        ...
        <p>
          ...
          Michel ML is created with the help of the
        ...
        <p>
          ...
          our Terms and Conditions, accessible from https://michelml.com/
        </p>
        ...
        <p>Michel ML uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          Michel ML will take all steps reasonably necessary to ensure that your
        ...
        <p>
          Michel ML may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of Michel ML</li>
          <li>
        ...
        <ul>
          <li>By email: michmoreau.l@gmail.com</li>
        </ul>
      </main>
    );
  }
